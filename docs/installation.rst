...
The sources for CircPacker can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/aarizatr/circpacker
.. _tarball: https://github.com/aarizatr/circpacker/tarball/master
